	...
	<table cellSpacing="1" cellPadding="5" width="100%" align="center"
		...
		<tr>
			<td class="ta_01" align="center" bgColor="#afd1f3" colSpan="4" height="26">
				<strong>编辑业务机构</strong>
			</td>
		</tr>
		<tr>
			<td align="center" bgColor="#f5fafe" class="ta_01">业务机构编码：</td>
			<td class="ta_01" bgColor="#ffffff">
				<input type="text" name="bid" class="bg" disabled value="${business.bid}" />
			</td>
			<td align="center" bgColor="#f5fafe" class="ta_01">业务机构名称：</td>
			<td class="ta_01" bgColor="#ffffff">
				<input type="text" name="bName" class="bg" value="${business.bName}" />
			</td>
		</tr>
		<tr>
			<td align="center" bgColor="#f5fafe" class="ta_01">业务类型名称：</td>
			<td class="ta_01" bgColor="#ffffff">
				<input type="text" class="bg" value="${business.bkid}" disabled/>
			</td>
			<td align="center" bgColor="#f5fafe" class="ta_01">业务机构描述：</td>
			<td class="ta_01" bgColor="#ffffff">
				<textarea name="comment" class="bg">${business.comment}</textarea>
			</td>
